...
public:
    ...
    void saveToSQLDatabse(){
        cout << "Saving shopping cart to SQL database..." << endl;
    }

    void saveToMongoDatabse(){
        cout << "Saving shopping cart to Mongo database..." << endl;
    }

    void saveToRedisDatabse(){
        cout << "Saving shopping cart to Redis database..." << endl;
    }
};
...
int main(){
    ...
    db.saveToSQLDatabse();
    db.saveToRedisDatabse();
    db.saveToMongoDatabse();
